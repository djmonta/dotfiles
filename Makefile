...
DOTFILES_FILES    := .bash_profile .bashrc .dir_colors .emacs.d .gitconfig .gitignore .gittemplate .percol.d .tmux .tmux.conf .tmux-powerlinerc .zshenv .zsh .screenrc .subversion
